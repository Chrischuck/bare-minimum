  ...
  render() {
    ...
    return (
      <div className="row input-row">
        <div
          className="form-group has-success is-empty col-md-5 col-sm-5 col-xs-5"
          style={{ paddingLeft: '0px', paddingRight: '5px', marginBottom: 5 }}
        >
          <label
          ...
          >
            ...
            <span
              className="semi-bold"
              style={{ color: '#99999c', fontSize: '13px', fontWeight: 500 }}
            >
              (optional)
            </span>
          </label>
        ...
        <div
          className="form-group has-success is-empty col-sm-4 col-md-4 col-xs-4"
          style={{ paddingLeft: '0px', paddingRight: '5px', marginBottom: 5 }}
        >
          <label
            htmlFor={`${inputCount}grade`}
        ...
        <div
          className="form-group has-success is-empty col-sm-3 col-md-3 col-xs-3"
          style={{ paddingLeft: '0px', paddingRight: '0px', marginBottom: 5 }}
        >
          <label
